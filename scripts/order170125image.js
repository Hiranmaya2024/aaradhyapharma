        ...
        if (selectedCompany) {
            ...
            companyItems.forEach(item => {
                ...
                tr.innerHTML = `
                    ...
                    <td>${item[5]}</td> <!-- Tax -->
                    <td>${item[6]}</td> <!-- Stock -->
                    <td><input type="number" class="form-control quantity-input quantity-input-small" data-item="${item[1]}" data-rate="${item[3]}" data-tax="${item[5]}" min="1"></td>
                    <td><button class="btn btn-sm btn-primary add-to-cart-button" data-item="${item[1]}" data-rate="${item[3]}" data-tax="${item[5]}" data-image="${imageUrl}">Add</button></td>
                `;
